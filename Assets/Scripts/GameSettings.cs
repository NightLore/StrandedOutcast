...
/* 6 */ new Weapon(   "Pickaxe", recipe.Reset().Set(STICK, 3).Set(ROCK, 3).GetRecipe(),  STONEPICK,  2, new Vector3(2.0f, 1.5f, 1.5f), 2.5f, 20),
/* 7 */ new Weapon(  "MetalAxe", recipe.Reset().Set(STICK, 5).Set(METAL, 5).GetRecipe(), BATTLEAXE, 12, new Vector3(7.0f, 4.0f, 1.5f), 1.5f, 30),
